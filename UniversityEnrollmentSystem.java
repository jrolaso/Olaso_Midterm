...
public class UniversityEnrollmentSystem {
    ...
    public static void main(String[] args) {
        ...
        Student student1 = new Student("Jorich", 20, "231005107", "Computer Engineering", 8);
        Student student2 = new Student("Nicole", 19, "231000329", "Computer Engineering", 8);
        
        // Creating Instructor objects
        Instructor instructor1 = new Instructor("Engr.Tanya", 22, "CPE 211", "College of Engineering ", 150000);
        Instructor instructor2 = new Instructor("Engr. Xarrahlyn", 45, "S5101", "College of Engineering", 200000);
